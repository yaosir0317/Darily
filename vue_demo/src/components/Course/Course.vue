        ...
        <div class="main">
            <div class="header">
                ...
                <div class="filter">
                    <ul>
                        <li>筛&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;选:</li>
                        <li :class='{active:myIndex===i,change1:filterIndex === 0,change2:filterIndex === 1}'
                            v-for='(item,i) in filterList' :key='item.id' @click='filterHandler(i,item.query)'>{{
                            item.title }}
                        </li>
                    </ul>
            ...
            <div class="courseList">
                <dl @click='courseHandler(course.pk)' v-for='(course,index) in courseDetail' :key='course.id'>
                    <dt>
